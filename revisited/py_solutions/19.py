# From https://github.com/evanphoward/AdventOfCode/blob/main/AOC_22/Day19/main.py
...
def num_geodes(o_cost, c_cost, ob_cost, g_cost, t_left, ore_robots, clay_robots, ob_robots, g_robots, ore, clay, ob,
    ...
    if True:
        ...
        if ore >= ob_cost[0] and clay >= ob_cost[1]:
            options.append(num_geodes(o_cost, c_cost, ob_cost, g_cost, t_left - 1, ore_robots, clay_robots, ob_robots + 1, g_robots,
                        ore - ob_cost[0] + ore_robots, clay - ob_cost[1] + clay_robots, ob + ob_robots,
                        geodes + g_robots))
